...
const MenuPage = () => {
  return (
    ...
    <div className="menu-page">
      <Navbar/>
      <img src={require("../assets/Maryam/menu.jpg")} alt="Header"/>
      <div className="content">
        ...
        {/* Continental Menus */}
        <div className="menu">
          <img src={require("../assets/Maryam/continental.jpg")} alt="Continental Menu" />
        ...
        {/* Hi Tea Menus */}
        <div className="menu">
          <img src={require("../assets/Maryam/hi tea.jpg")} alt="hi tea Menu" />
          <h2>Hi Tea Menus</h2>
          <table>
            <thead>
              <tr>
        ...
        {/* Iftar Menus */}
        <div className="menu">
          <img src={require("../assets/Maryam/iftar.JPG")} alt="iftar Menu" />
          <h2>Iftar Menus</h2>
          <table>
            <thead>
              <tr>
        ...
        {/* Breakfast Menus */}
        <div className="menu">
          <img src={require("../assets/Maryam/breakfast.jpg")} alt="Header" />
